...
kubectl delete deployment customer-authentication --namespace=dev --ignore-not-found=true
kubectl delete service customer-authentication --namespace=dev --ignore-not-found=true
